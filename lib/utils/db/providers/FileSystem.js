...
util.inherits(fileStorage, Provider);
...
fileStorage.prototype.insert = function (data, callback) {
    try {
        if (data && typeof data == "object" && data._content_type_uid && data._uid) {
            ...
            if (contentTypeId == "_content_types") data['_data'] = helper.findReferences(data['_data'], '_data');
...
fileStorage.prototype.upsert = function (data, callback) {
    try {
        if (data && typeof data == "object" && data._content_type_uid && data._uid) {
            ...
            // updating the references based on the new schema
            // ~Modified :: findReferences method now accepts parent key
            if (contentTypeId === '_content_types') _query['_data'] = helper.findReferences(_query['_data'], '_data');
