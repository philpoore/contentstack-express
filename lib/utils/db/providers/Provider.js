...
Provider.prototype.includeReferences = function (data, _locale, references, parentID, callback) {
    log.error(this.provider + ' is missing findOne() implementation!');
    log.warn('Loading default filesystem findOne()');
...
Provider.prototype.findOne = function (query, _callback) {
	log.error(this.provider + ' is missing findOne() implementation!');
	log.warn('Loading default filesystem findOne()');
    try {
...
Provider.prototype.count = function (query, callback) {
    log.error(this.provider + ' is missing count() implementation!');
    log.warn('Loading default filesystem count()');
    try {
        if (query && typeof query == "object") {
...
Provider.prototype.insert = function (data, callback) {
    log.error(this.provider + ' is missing insert() implementation!');
    log.warn('Loading default filesystem insert()');
    try {
...
Provider.prototype.upsert = function (data, callback) {
    log.error(this.provider + ' is missing upsert() implementation!');
    log.warn('Loading default filesystem upsert()');
    try {
        if (data && typeof data == "object" && data._content_type_uid && data._uid) {
            var entries = [],
...
Provider.prototype.remove = function (query, callback) {
    log.error(this.provider + ' is missing remove() implementation!');
    log.warn('Loading default filesystem remove()');
    try {
        if (query && typeof query == "object") {
