...
CDN.prototype.find = function (query, options, callback) {
  try {
    if(_.isPlainObject(query)) {
      ...
      // Set url
      url = _query.__url || ((_query._content_type_uid === assetRoute) ? (apiHost + contentstack.urls.assets) : (apiHost + contentstack.urls.content_types + _query._content_type_uid + contentstack.urls.entries));
