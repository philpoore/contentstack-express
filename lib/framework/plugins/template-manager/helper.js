...
// To get the partials
    var get = function (partial, limit, language, include_references) {
        return new Promise(function (resolve, reject) {
            find({"content_type": partial, "language": language, "include_references": include_references}, [], []).then(function (entry) {
    ...
    function find(query, references, buckets) {
        return new Promise(function (resolve, reject) {
            ...
            if(data) {
                ...
                includeReferences(data, language, references, buckets).then(function (data) {
                    resolve(data);
                });
    ...
    function includeReferences(data, language, references, buckets) {
        return new Promise(function (resolve, reject) {
                ...
                for (var _key in data) {
                    ...
                    if (typeof data[_key] === "object") {
                        if (data[_key] && data[_key]["_content_type_id"]) {
                            ...
                            find(_query, references).then(function () {
