...
// To get the partials
    var get = function (partial) {
        return new Promise(function (resolve, reject) {
            console.log('@View-Helper partial', partial)
            var language = context.get('lang'),
                limit = 1,
    ...
    function find(query) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if(data) {
                ...
                _db(contentTypeUid, query).then(function (result) {
