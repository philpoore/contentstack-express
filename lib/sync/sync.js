                            ...
                            _requests.push(function (i) {
                                return function (_cb) {
                                    request({
                                        ...
                                        if (!err && res.statusCode == 200 && body && body.assets && body.assets.length) {
                                            _assetsIds = _assetsIds.concat(body.assets);
                                            _cb();
                                        } else {
                                            _cb(body);
                                        }
                        ...
                        async.series(_requests, function (err) {
                            if (!err) {
                                if (_assetsIds.length == assetsIds.length) {
                                    ...
                                    _assetsIds = _.map(_assetsIds, "uid");
